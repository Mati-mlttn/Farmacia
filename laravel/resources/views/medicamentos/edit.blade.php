            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        <div class="card-body">
                            <form id="form" method="post" action="{{ route('medicamentos.update', $item->id) }}">
                                @method('PUT')
                                @csrf
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" id="inputNombre" name="nombre" type="text" value="{{ $item->nombre }}"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" id="inputCantidad" name="cantidad" type="number" value="{{ $item->cantidad }}"
